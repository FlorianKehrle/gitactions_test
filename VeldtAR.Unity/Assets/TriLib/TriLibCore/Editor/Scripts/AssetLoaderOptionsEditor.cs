            ...
            switch (currentTab)
            {
                case 0:
                    ...
                    if (importMeshesProperty.boolValue)
                    {
                        ...
                        EditorGUILayout.PropertyField(serializedObject.FindProperty("ImportBlendShapeNormals"), new GUIContent("Turn on this field to import Mesh Blend Shape normals. If not enabled, normals will be calculated instead."));
